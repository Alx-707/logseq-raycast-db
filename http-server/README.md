...
**Current: v0.0.5** - See [VERSION.md](VERSION.md) for changelog

### 🐛 Bug Fix in v0.0.5

Fixed `EPERM: operation not permitted, uv_cwd` error that prevented the `/list` command from working. The server now explicitly sets a safe working directory when executing Logseq CLI commands.

### ⚠️ Breaking Change in v0.0.4

**Version 0.0.4 requires @logseq/cli v4.0 or higher.**
